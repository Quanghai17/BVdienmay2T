...
<div class="breadcrumb_background bread_other" style="background-image: url({{ Voyager::image(setting('site.breadcrumb')) }})">
    <div class="title_full">
        <div class="container a-center">
            <h1 class="title_page">Bảng giá dịch vụ</h1>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-12 a-left">
                    <ul class="breadcrumb">
                        ...
                        <li><strong><span>Bảng giá dịch vụ</span></strong></li>
                ...
                <div class="col-xl-10 col-lg-10 col-12">
                    <div class="box_advisor_right">
                        ...
                        <h2 class="title_advisor_2" style="text-align: center;">
                            <span>Bảng giá dịch vụ của chúng tôi</span>
                        </h2>
                        <style>
                            table {
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 a-left">
                            <a href="{{route('advises')}}"><button type="submit" class="btn btn-primary btn-lienhe">Liên hệ tư vấn dịch vụ</button></a>
                        </div>
