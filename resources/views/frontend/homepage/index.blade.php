                                    ...
                                    <div class="service_item_ed">
                                        <span class="iconx">
                                            <img alt="Dịch vụ nhanh chóng" class="lazyload"
                                                ...
                                                data-src="https://bizweb.dktcdn.net/100/425/159/themes/894862/assets/icon_about_1.png?1676275680316" />
                                        </span>
                                        <div class="content_srv">
                                            <span class="title_service">Đội ngũ kỹ thuật viên chuyên nghiệp, tận tâm và trung thực  </span>
                                    ...
                                    <div class="service_item_ed">
                                        <span class="iconx">
                                            <img alt="Hỗ trợ 24/7" class="lazyload"
                                                src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAAAXNSR0IArs4c6QAAAARnQU1BAACxjwv8YQUAAAAJcEhZcwAADsQAAA7EAZUrDhsAAAANSURBVBhXYzh8+PB/AAffA0nNPuCLAAAAAElFTkSuQmCC"
                                                data-src="https://bizweb.dktcdn.net/100/425/159/themes/894862/assets/icon_about_2.png?1676275680316" />
                                        </span>
                                        <div class="content_srv">
                                            <span class="title_service">Hỗ trợ 24/7</span>
                                            <span class="content_service">Thời gian đáp ứng nhanh chóng và dịch vụ tận nhà khi cần thiết</span>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="service_item_ed">
                                        <span class="iconx">
                                            <img alt="Bảo hành chu đáo" class="lazyload"
                                                src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAAAXNSR0IArs4c6QAAAARnQU1BAACxjwv8YQUAAAAJcEhZcwAADsQAAA7EAZUrDhsAAAANSURBVBhXYzh8+PB/AAffA0nNPuCLAAAAAElFTkSuQmCC"
                                                data-src="https://bizweb.dktcdn.net/100/425/159/themes/894862/assets/icon_about_3.png?1676275680316" />
                                        </span>
                                        <div class="content_srv">
                                    ...
                                    <div class="blog_thumbnail">
                                        <a class="image-blog"
                                            ...
                                            <img width="480" height="356" style="height: 206px"
                                                ...
                                                {{-- data-src="{{ Voyager::image($post->getThumbnails($image, 'medium')) }}" --}}
                                                alt="{{$post->title}}"
