                        ...
                        <div class="box_advisor_right">
                            ...
                            <div id="pagelogin">
                                <form method="post" action="{{route('book')}}" id="contact" accept-charset="UTF-8">
                                    ...
                                    {{-- <input type="hidden" value="abc"  name="services"> --}}
                                    ...
                                    <div class="form-signup clearfix">
                                        <div class="row group_contact">
                                            ...
                                            <fieldset class="form-group col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                                <input placeholder="Tỉnh" type="text"
                                                    id="email1" class="form-control form-control-lg" value=""
                                                    name="province">
                                                    
                                            </fieldset>
                                            <fieldset class="form-group col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                                <input placeholder="Thành phố/ Huyện" type="text" class="form-control form-control-lg" value=""
                                                    name="district">
                                            </fieldset>
                                            <fieldset class="form-group col-lg-6 col-md-12 col-sm-12 col-xs-12">
